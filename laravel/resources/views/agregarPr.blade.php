 ...
 <body class="bg-surface text-on-surface antialiased overflow-hidden">
  ...
  <aside class="fixed left-0 top-0 h-full flex flex-col py-6 bg-[#041329] dark:bg-[#041329] w-64 border-r-0 z-50">
   ...
   <nav class="flex-1 space-y-1">
    <a class="flex items-center py-3 font-['Inter'] antialiased tracking-tight text-[0.875rem] uppercase font-bold text-[#c2c6d3] hover:bg-[#0d1c32] pl-4 transition-colors duration-150" href="#">
    ...
    <a class="flex items-center py-3 font-['Inter'] antialiased tracking-tight text-[0.875rem] uppercase font-bold text-[#ffb3b1] bg-[#1c2a41] border-l-4 border-[#ee3f4b] pl-3 transition-colors duration-150" href="#">
      ...
      <div class="col-span-12 bg-surface-container-low p-8 border-l-2 border-primary">
       ...
       <div class="grid grid-cols-2 gap-6">
        <div class="space-y-1">
         ...
         <input class="w-full bg-surface-container-highest border-0 border-b-2 border-secondary-fixed-dim focus:border-on-primary-container focus:ring-0 text-on-surface text-sm placeholder:opacity-30" placeholder="Industrial Component X-100" type="text"/>
        </div>
        <div class="space-y-1">
         <label class="text-[10px] font-bold text-secondary uppercase tracking-wider">
          Manufacturer
         </label>
         <input class="w-full bg-surface-container-highest border-0 border-b-2 border-secondary-fixed-dim focus:border-on-primary-container focus:ring-0 text-on-surface text-sm placeholder:opacity-30" placeholder="Global Systems Corp" type="text"/>
        </div>
       </div>
      </div>
       ...
       <div class="grid grid-cols-2 gap-6">
        <div class="space-y-1">
         ...
         <div class="relative">
          ...
          <input class="w-full pl-8 bg-surface-container-highest border-0 border-b-2 border-secondary-fixed-dim focus:border-on-primary-container focus:ring-0 text-on-surface font-mono text-lg" placeholder="0.00" step="0.01" type="number"/>
         </div>
        </div>
        <div class="space-y-1">
         <label class="text-[10px] font-bold text-secondary uppercase tracking-wider">
         ...
         <div class="relative">
          ...
          <input class="w-full bg-surface-container-highest border-0 border-b-2 border-secondary-fixed-dim focus:border-on-primary-container focus:ring-0 text-on-surface font-mono text-lg" placeholder="0" type="number"/>
         </div>
        </div>
       </div>
      </div>
      ...
      <div class="col-span-5 bg-surface-container-low p-8">
       ...
       <div class="space-y-4">
        <div class="space-y-1">
         ...
         <input class="w-full bg-surface-container-highest border-0 border-b-2 border-secondary-fixed-dim focus:border-on-primary-container focus:ring-0 text-on-surface text-xs" placeholder="100x200x50 mm" type="text"/>
        </div>
        <div class="space-y-1">
         <label class="text-[10px] font-bold text-secondary uppercase tracking-wider">
          Operational Weight
         </label>
         <input class="w-full bg-surface-container-highest border-0 border-b-2 border-secondary-fixed-dim focus:border-on-primary-container focus:ring-0 text-on-surface text-xs" placeholder="12.5 kg" type="text"/>
        </div>
       </div>
      </div>
